...
const ButtonTest   = <HTMLButtonElement>document.getElementById("difficultyTest");
const ButtonEasy   = <HTMLButtonElement>document.getElementById("difficultyEasy");
const ButtonMedium = <HTMLButtonElement>document.getElementById("difficultyMedium");
const ButtonHard   = <HTMLButtonElement>document.getElementById("difficultyHard");
const ButtonRandom = <HTMLButtonElement>document.getElementById("difficultyRandom");

const titleSiadoku       = <HTMLInputElement>document.getElementById("titleSiadoku")
const gameBoard          = <HTMLInputElement>document.getElementById("gameContainer");
const mainMenu           = <HTMLInputElement>document.getElementById("mainMenu");
const highScores         = <HTMLInputElement>document.getElementById("highScores");
const scoreTableButton   = <HTMLButtonElement>document.getElementById("scoreTableButton");
const showHintsButton    = <HTMLButtonElement>document.getElementById("showHintsButton");
const revealNumberButton = <HTMLButtonElement>document.getElementById("revealNumberButton");
const showSolutionButton = <HTMLButtonElement>document.getElementById("showSolutionButton");
const nickNameInput      = <HTMLInputElement>document.getElementById("nickNameInput");
const backToMenu         = <HTMLButtonElement>document.getElementById("backToMenu");
const optionsButton      = <HTMLButtonElement>document.getElementById("options");
const scoreField         = <HTMLInputElement>document.getElementById("score");
...
function getBoard(difficulty:string) {  
    switch (difficulty) {
...
function getSolution(difficulty:string) {
    switch (difficulty) {
...
function createBoard(board) {
    for (let r = 0; r < 9; r++) {
        for (let c = 0; c < 9; c++) {
            let tile = <HTMLInputElement>document.getElementById(String(r)+String(c));
            if(board[r][c] != 0) {
    ...
    document.onkeydown = function (event) {      
        ...
        function checkIfWin() {
            ...
            if(ok == 81) {   
                ...
                switch (difficulty) {
                    case "test":score = score + 1000;
                    break;
                    
                    case "easy":score = score + 25;
                    break;
                    
                    case "medium":score = score + 50;
                    break;
                    
                    case "hard":score = score + 100;
                    break;
...
function revealOneNumber() {
    if(tileSelected != null) {   
        if((tileSelected.innerText == "") && (revealedNumbers == 0)) {
            let solution:number[][] = getSolution(difficulty)
